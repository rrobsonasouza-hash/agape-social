...
export default function LoginPage() {
  ...
  useEffect(() => { if (!carregando && usuario) router.replace(usuario.role === "admin_plataforma" ? "/central" : usuario.role === "atendente_secretaria" ? "/secretaria" : usuario.role === "tesoureiro" ? "/tesouraria" : "/dashboard"); }, [carregando, router, usuario]);
