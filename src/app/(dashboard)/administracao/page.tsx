    ...
    <div className="space-y-6">
      ...
      <FormSection title="Backup da paróquia" description="Baixe uma cópia com verificação de integridade dos cadastros, dízimos, finanças, sacramentos e históricos. Senhas e chaves nunca são incluídas.">
        ...
        <div className="mt-5 border-t pt-5">
          ...
          {!carregandoNuvem&&backupsNuvem.length===0&&<p className="mt-4 rounded-xl bg-slate-50 p-4 text-sm text-slate-500">Clique em “Ver backups” para consultar o cofre ou em “Salvar na nuvem” para criar a primeira cópia.</p>}
        </div>
      </FormSection>
    </div>
  );
