...
function LegacyAdministradoresPlataformaPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-100">
      ...
      <div className="mx-auto grid max-w-6xl gap-6 p-8 lg:grid-cols-[380px_1fr]">
...
void LegacyAdministradoresPlataformaPage;
export { default } from "./administradores-page";
