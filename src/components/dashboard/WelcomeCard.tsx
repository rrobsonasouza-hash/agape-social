  ...
  return (
    <div className="rounded-xl border bg-white p-8 shadow-sm">
      ...
      <blockquote className="mt-6 border-l-4 border-blue-600 pl-4 italic text-gray-600">
        &ldquo;Todas as vezes que fizestes isso a um destes meus irmãos
        mais pequeninos, foi a mim que o fizestes.&rdquo;
      </blockquote>

      <p className="mt-2 text-sm text-gray-500">Mateus 25,40</p>
    </div>
  );
}
