...
import { BarChart3, ClipboardList, Gift, HandHeart, Handshake, HeartHandshake, History, LayoutDashboard, MapPinned, Package, Route, Settings, ShieldCheck, Users } from "lucide-react";
...
const menu = [
  ...
  { title: "Usuários", href: "/usuarios", icon: ShieldCheck }, { title: "Auditoria", href: "/auditoria", icon: History },
];
