...
type Props = {
  ...
  presencasDiarias: EccPresencaDia[]; onSaved: () => Promise<void>;
};
...
export function CredenciamentoEccSection({ encontroId, dataInicio, dataFim, participacoes, casais, credenciamentos, presencasDiarias, onSaved }: Props) {
